...
namespace FSharp.Charting
    ...
    *)
        ...
        /// The placement of the tick mark.
        // TM
        type TickMarkStyle = 
            | None = 0
            | OutsideArea = 1
        ...
        let internal DefaultFontForTitles = new Font("Arial", 14.0f, FontStyle.Regular)     //16.0
        let internal DefaultFontForAxisLabels = new Font("Arial", 14.0f, FontStyle.Regular) //12.0
        let internal DefaultFontForOthers = new Font("Arial Narrow", 12.0f, FontStyle.Regular)//10.0
        ...
        let internal PropertyDefaults = 
            [ // Define type specific defaults
              ...
              //{ ChartStyleDefault.ChartType = Some(Charting.SeriesChartType.Line); ParentParentType=None; ParentType = Some(typeof<Charting.Series>); PropertyName="BorderWidth"; PropertyDefault=(box 3) }
              { ChartStyleDefault.ChartType = None; ParentParentType=None; ParentType = Some(typeof<Charting.Series>); PropertyName="BorderWidth"; PropertyDefault=(box 3) }
              ...
              //{ ChartStyleDefault.ChartType = None; ParentParentType=None; ParentType = Some(typeof<Charting.Legend>); PropertyName="IsDockedInsideChartArea"; PropertyDefault=(box false) }
              // TM : My scientific style
              { ChartStyleDefault.ChartType = None; ParentParentType=None; ParentType = Some(typeof<Charting.ChartArea>); PropertyName="BorderDashStyle"; PropertyDefault=(box DashStyle.Solid) }                            
              ...
              { ChartStyleDefault.ChartType = None; ParentParentType=Some(typeof<Charting.Axis>); ParentType = Some(typeof<Charting.TickMark>); PropertyName="TickMarkStyle"; PropertyDefault=(box TickMarkStyle.OutsideArea) }
              { ChartStyleDefault.ChartType = None; ParentParentType=Some(typeof<Charting.Axis>); ParentType = Some(typeof<Charting.TickMark>); PropertyName="Size"; PropertyDefault=(box 1.5f) }
              { ChartStyleDefault.ChartType = None; ParentParentType=Some(typeof<Charting.Axis>); ParentType = Some(typeof<Charting.TickMark>); PropertyName="LineWidth"; PropertyDefault=(box 1) }              
              { ChartStyleDefault.ChartType = None; ParentParentType=None; ParentType = Some(typeof<Charting.Axis>); PropertyName="Crossing"; PropertyDefault=(box Double.MinValue) } 
              { ChartStyleDefault.ChartType = None; ParentParentType=None; ParentType = Some(typeof<Charting.Axis>); PropertyName="LineWidth"; PropertyDefault=(box 1) } 
              //{ ChartStyleDefault.ChartType = None; ParentParentType=None; ParentType = Some(typeof<Charting.Axis>); PropertyName="LineDashStyle"; PropertyDefault=(box Charting.ChartDashStyle.Dot ) }  
              { ChartStyleDefault.ChartType = None; ParentParentType=None; ParentType = Some(typeof<Charting.Axis>); PropertyName="TitleFont"; PropertyDefault=(box DefaultFontForAxisLabels ) }                
              { ChartStyleDefault.ChartType = None; ParentParentType=None; ParentType = Some(typeof<Charting.Axis>); PropertyName="LabelAutoFitMaxFontSize"; PropertyDefault=(box 12 ) }  
              { ChartStyleDefault.ChartType = None; ParentParentType=None; ParentType = Some(typeof<Charting.Axis>); PropertyName="LabelAutoFitMinFontSize"; PropertyDefault=(box 8 ) }    
    ...
    *)
        ...
        let internal applyDefaults (chartType:SeriesChartType, target:'a, targetParentType:Type option, targetType:Type, property:PropertyInfo) = 
            let isMatch propDefault = 
                ...
                (propDefault.ParentType |> Option.forall (fun parentType -> parentType = targetType)) &&  // TM : Check if types are matching (#bug: grid and tickmark enabled)               
        ...
        [<Sealed>]
        type Grid( ?Enabled, ?Interval, ?IntervalOffset, ?IntervalOffsetType, ?LineColor, ?LineDashStyle:DashStyle, ?LineWidth) = 
            ...
            do
              ...
              //LineDashStyle |> Option.iter grid.set_LineDashStyle                // TM
              LineDashStyle |> Option.iter (int >> enum >> grid.set_LineDashStyle) // TM
              LineWidth |> Option.iter grid.set_LineWidth
            member internal x.Handle = grid

        [<Sealed>]
        type TickMark( ?Size:float, ?Style:TickMarkStyle, ?Enabled, ?Interval, ?IntervalOffset, ?IntervalOffsetType, ?LineColor, ?LineDashStyle:DashStyle, ?LineWidth) = 
            ...
            do
              ...
              //LineDashStyle |> Option.iter tickMark.set_LineDashStyle   // TM
              LineDashStyle |> Option.iter (int >> enum >> tickMark.set_LineDashStyle)
              LineWidth |> Option.iter tickMark.set_LineWidth
              //Size |> Option.iter tickMark.set_Size
              Size |> Option.iter (float32 >> tickMark.set_Size)  // TM
              // Style |> Option.iter tickMark.set_TickMarkStyle  // TM
              Style |> Option.iter (int >> enum >> tickMark.set_TickMarkStyle)
