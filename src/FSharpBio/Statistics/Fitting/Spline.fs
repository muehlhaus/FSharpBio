...
//http://bramjochems.com/blog/2014/08/spline-interpolation-f/
...
module Spline =
    ...
    let smoothingSpline (data: (float*float) []) (basispts : float [])=
        ...
        fun (lambda: float) ->
            ...
            let theta = (BtB + n'*lambda*Omega).Inverse()
