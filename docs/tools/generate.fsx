...
let website = "/FSharpBio"

let githubLink = "http://github.com/muehlhaus/FSharpBio"
...
let info =
  [ "project-name", "FSharpBio"
    ...
    "project-nuget", "http://nuget.org/packages/FSharpBio" ]
...
//let tmpBin = [@"C:\Users\Timo\SkyDrive\Development\Source\FSharpBio\bin\FSharpBio.dll";]
...
let buildReference () =
  ...
  MetadataFormat.Generate
    ...
    //( tmpBin, output @@ "reference", layoutRootsAll.["en"],
