...
let description = "FSharpBio aims to be a user-friendly library for Bioinformatics written in F#."

// List of author names (for NuGet package)
let authors = [ "Timo Mühlhaus" ]

// Tags for your project (for NuGet package)
let tags = "bioinformatics computational biology"

// File system information 
let solutionFile  = "FSharpBio.sln"
